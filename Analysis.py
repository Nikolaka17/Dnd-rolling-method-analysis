...
ax3[0][0].plot(np.array(mods), np.ones((6, 13), dtype=float) - d20_skill, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
ax3[0][1].plot(np.array(mods), np.ones((6, 13), dtype=float) - r3d6_skill, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
ax3[1][0].plot(np.array(mods), np.ones((6, 13), dtype=float) - r2d10_skill, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
ax3[2][0].plot(np.array(mods), np.ones((6, 13), dtype=float) - r5d4_skill, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
ax3[2][1].plot(np.array(mods), np.ones((6, 13), dtype=float) - r4d4_skill, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
ax3[1][1].plot(np.array(mods), np.ones((6, 13), dtype=float) - d10add10, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
ax3[0][2].plot(np.array(mods), np.ones((6, 13), dtype=float) - r10d2_skill, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
ax3[2][2].plot(np.array(mods), np.ones((6, 13), dtype=float) - r20d1_skill, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
ax3[1][2].plot(np.array(mods), np.ones((6, 13), dtype=float) - flat10_skill, color=['green', 'blue', 'purple', 'yellow', 'orange', 'red'], label=['DC 5', 'DC 10', 'DC 15', 'DC 20', 'DC 25', 'DC 30'])
